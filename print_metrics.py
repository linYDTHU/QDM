"""
Codes from https://github.com/wyf0912/SinSR/blob/main/evaluate.py
"""
...
def evaluate(in_path, ref_path, ntest, eval_y_channel=False, reference_only=False):
    metric_dict = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_y_channel', action='store_true', help='evaluate on y channel')
    parser.add_argument('--reference_only', action='store_true', help='evaluate only reference metrics')

    args = parser.parse_args()
    evaluate(args.in_path, args.ref_path, args.ntest, args.val_y_channel ,args.reference_only)
