...
from .respace import SpacedDiffusion, space_timesteps, SpacedDiffusionDDPM, MaskedSpacedDiffusion
...
def create_masked_gaussian_diffusion(
    *,
    normalize_input,
    schedule_name,
    sf=4,
